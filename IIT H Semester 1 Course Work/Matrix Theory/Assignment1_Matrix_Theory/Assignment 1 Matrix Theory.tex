...
\begin{abstract}
This document explains the concept of finding the angle between the two vectors
\end{abstract}
Download all python codes from 
%
\begin{lstlisting}
https://github.com/venkateshelangovan/IIT-Hyderabad-Assignments/blob/master/Assignment%201%20Matrix%20Theory%20.ipynb
\end{lstlisting}
%
and latex-tikz codes from 
%
\begin{lstlisting}
https://github.com/venkateshelangovan/IIT-Hyderabad-Assignments
\end{lstlisting}
%
\section{Problem}
...
\newline
\\
Dot product between two vectors a and b is given by , 
\begin{align}
 \vec{a}^T\vec{b} =\norm{\vec{a}}\norm{\vec{b}}\cos\theta
\end{align}
Where angle between the vectors a and b is denoted by \theta
\section{Solution}
Let , \vec{a}=\myvec{
1\\
-2\\

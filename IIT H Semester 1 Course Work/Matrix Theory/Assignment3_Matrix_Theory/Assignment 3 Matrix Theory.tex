...
\begin{abstract}
This document explains the concept of matrix multiplication
\end{abstract}
Download all latex-tikz codes from 
%
\begin{lstlisting}
https://github.com/venkateshelangovan/IIT-Hyderabad-Assignments/tree/master/Assignment3_Matrix_Theory
\end{lstlisting}
%
\section{Problem}
...
&=F(x+y)
\end{align}
Equation 2.0.5 is F(x+y) i.e RHS of the problem statement. Here we arrived at RHS by solving the LHS F(x)F(y)\\
Therefore, 
\begin{align}
    F(x)F(y)=F(x+y)
\end{align}

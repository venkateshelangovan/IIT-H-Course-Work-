...
\begin{abstract}
This document explains the concept of finding the equation of line passing through the points
\end{abstract}
Download all latex-tikz codes from 
%
\begin{lstlisting}
https://github.com/venkateshelangovan/IIT-Hyderabad-Assignments/tree/master/Assignment2_Matrix_Theory
\end{lstlisting}
%
\section{Problem}
...
\section{Equation of the line passing throught two points }
Consider the two points, a and b in 3-Dimensional co-ordinates, 
\\
Parametric equation of the line passing through two points a and b is given by,\\
\begin{align}
\vec{x}=a+\lambda(A)
\end{align}
Where ,Direction Vector,A=\vec{b}-\vec{a}
...
Equation of the line passing through points a and b is given by:
\begin{align}
\vec{x}
=\myvec{
3\\
